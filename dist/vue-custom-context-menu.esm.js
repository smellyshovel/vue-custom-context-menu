import { resolveDirective, withDirectives, openBlock, createBlock, renderSlot, withScopeId, pushScopeId, popScopeId, resolveComponent, createVNode, withModifiers, createCommentVNode } from 'vue';
...
const _withId$1 = /*#__PURE__*/withScopeId("data-v-fca6041c");
...
const _withId = /*#__PURE__*/withScopeId("data-v-2cd1f2a4");

pushScopeId("data-v-2cd1f2a4");
const _hoisted_1 = { class: "context-menu" };
popScopeId();

const render$1 = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_context_menu_overlay = resolveComponent("context-menu-overlay");

  return ($data.show)
    ? (openBlock(), createBlock(_component_context_menu_overlay, {
        key: 0,
        ref: "overlay",
        "is-root": $data.isRoot,
        "z-index": $data.zIndex,
